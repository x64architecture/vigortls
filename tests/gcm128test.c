...
static int do_gcm128_test(int testnum, struct gcm128_test *tv)
{
    GCM128_CONTEXT ctx;
    AES_KEY key;
    uint8_t *out;
    ...
    if (tv->C_len > 0 && memcmp(out, tv->C, outlen)) {
    ...
    if (tv->P_len > 0 && memcmp(out, tv->P, outlen)) {
