...
typedef struct ssl3_state_st {
     ...
     */
    uint8_t *tlsext_authz_client_types;
    size_t tlsext_authz_client_types_len;
    /*
     * tlsext_authz_promised_to_client is true if we're a server and we
    ...
    /*
     * tlsext_authz_server_promised is true if we're a client and the
