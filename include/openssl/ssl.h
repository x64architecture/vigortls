...
struct ssl_ctx_st {
    ...
    /*
     * This can have one of 2 values, OR'd together, SSL_SESS_CACHE_CLIENT or
...
struct ssl_st {
    ...
    /* Are we server side? - mostly used by SSL_clear() */
    int server;
    ...
    /*
     * AEAD context. If non-NULL, then enc_read_ctx and read_hash are
     * ignored.
     */
    ...
    /*
     * AEAD context. If non-NULL, then enc_write_ctx and write_hash are
     * ignored.
     */
...
# define SSL_R_MISSING_ECDH_CERT                          383
# define SSL_R_MISSING_ECDSA_SIGNING_CERT                 384
...
# define SSL_R_ONLY_DTLS_1_2_ALLOWED_IN_SUITEB_MODE       390
...
# define SSL_R_UNKNOWN_CMD_NAME                           388
...
# define SSL_R_WRONG_CERTIFICATE_TYPE                     385
