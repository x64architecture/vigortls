...
#define SKM_sk_pop_free(type, st, free_func) \
    sk_pop_free(CHECKED_STACK_OF(type, st),  \
...
#define SKM_ASN1_SET_OF_d2i(type, st, pp, length, d2i_func, free_func, ex_tag, \
    ...
    (STACK_OF(type) *)d2i_ASN1_SET(                                            \
        (STACK_OF(OPENSSL_BLOCK) **)CHECKED_PTR_OF(STACK_OF(type) *, st), pp,  \
...
#define SKM_ASN1_seq_unpack(type, buf, len, d2i_func, free_func)      \
    (STACK_OF(type) *)ASN1_seq_unpack(buf, len,                       \
...
#define sk_OPENSSL_STRING_insert(st, val, i)                                   \
    sk_insert(CHECKED_STACK_OF(OPENSSL_STRING, st), CHECKED_PTR_OF(char, val), \
              i)
...
#define sk_OPENSSL_STRING_find_ex(st, val)                                   \
    sk_find_ex((_STACK *)CHECKED_CONST_PTR_OF(STACK_OF(OPENSSL_STRING), st), \
               CHECKED_CONST_PTR_OF(char, val))
#define sk_OPENSSL_STRING_delete(st, i) SKM_sk_delete(OPENSSL_STRING, (st), (i))
#define sk_OPENSSL_STRING_delete_ptr(st, ptr)                             \
    (OPENSSL_STRING *)sk_delete_ptr(CHECKED_STACK_OF(OPENSSL_STRING, st), \
                                    CHECKED_PTR_OF(char, ptr))
...
#define sk_OPENSSL_BLOCK_pop_free(st, free_func)     \
    sk_pop_free(CHECKED_STACK_OF(OPENSSL_BLOCK, st), \
                CHECKED_SK_FREE_FUNC2(OPENSSL_BLOCK, free_func))
...
#define sk_OPENSSL_BLOCK_find_ex(st, val)                                   \
    sk_find_ex((_STACK *)CHECKED_CONST_PTR_OF(STACK_OF(OPENSSL_BLOCK), st), \
               CHECKED_CONST_PTR_OF(void, val))
#define sk_OPENSSL_BLOCK_delete(st, i) SKM_sk_delete(OPENSSL_BLOCK, (st), (i))
#define sk_OPENSSL_BLOCK_delete_ptr(st, ptr)                            \
    (OPENSSL_BLOCK *)sk_delete_ptr(CHECKED_STACK_OF(OPENSSL_BLOCK, st), \
                                   CHECKED_PTR_OF(void, ptr))
...
#define sk_OPENSSL_PSTRING_new(cmp)       \
    ((STACK_OF(OPENSSL_PSTRING) *)sk_new( \
...
#define sk_OPENSSL_PSTRING_push(st, val)           \
    sk_push(CHECKED_STACK_OF(OPENSSL_PSTRING, st), \
            CHECKED_PTR_OF(OPENSSL_STRING, val))
#define sk_OPENSSL_PSTRING_find(st, val)           \
    sk_find(CHECKED_STACK_OF(OPENSSL_PSTRING, st), \
            CHECKED_PTR_OF(OPENSSL_STRING, val))
...
#define sk_OPENSSL_PSTRING_insert(st, val, i)        \
    sk_insert(CHECKED_STACK_OF(OPENSSL_PSTRING, st), \
              CHECKED_PTR_OF(OPENSSL_STRING, val), i)
#define sk_OPENSSL_PSTRING_free(st) SKM_sk_free(OPENSSL_PSTRING, st)
#define sk_OPENSSL_PSTRING_set(st, i, val)           \
    sk_set(CHECKED_STACK_OF(OPENSSL_PSTRING, st), i, \
           CHECKED_PTR_OF(OPENSSL_STRING, val))
#define sk_OPENSSL_PSTRING_zero(st) SKM_sk_zero(OPENSSL_PSTRING, (st))
#define sk_OPENSSL_PSTRING_unshift(st, val)           \
    sk_unshift(CHECKED_STACK_OF(OPENSSL_PSTRING, st), \
               CHECKED_PTR_OF(OPENSSL_STRING, val))
#define sk_OPENSSL_PSTRING_find_ex(st, val)                                   \
    sk_find_ex((_STACK *)CHECKED_CONST_PTR_OF(STACK_OF(OPENSSL_PSTRING), st), \
...
#define sk_OPENSSL_PSTRING_set_cmp_func(st, cmp)                             \
    ((int (*)(const OPENSSL_STRING *const *, const OPENSSL_STRING *const *)) \
         sk_set_cmp_func(CHECKED_STACK_OF(OPENSSL_PSTRING, st),              \
                         CHECKED_SK_CMP_FUNC(OPENSSL_STRING, cmp)))
...
#define d2i_ASN1_SET_OF_ASN1_UTF8STRING(st, pp, length, d2i_func, free_func, \
                                        ex_tag, ex_class)                    \
    SKM_ASN1_SET_OF_d2i(ASN1_UTF8STRING, (st), (pp), (length), (d2i_func),   \
                        (free_func), (ex_tag), (ex_class))
#define i2d_ASN1_SET_OF_ASN1_UTF8STRING(st, pp, i2d_func, ex_tag, ex_class, \
                                        is_set)                             \
    SKM_ASN1_SET_OF_i2d(ASN1_UTF8STRING, (st), (pp), (i2d_func), (ex_tag),  \
                        (ex_class), (is_set))
...
#define d2i_ASN1_SET_OF_ESS_CERT_ID(st, pp, length, d2i_func, free_func, \
                                    ex_tag, ex_class)                    \
    SKM_ASN1_SET_OF_d2i(ESS_CERT_ID, (st), (pp), (length), (d2i_func),   \
                        (free_func), (ex_tag), (ex_class))
#define i2d_ASN1_SET_OF_ESS_CERT_ID(st, pp, i2d_func, ex_tag, ex_class, \
                                    is_set)                             \
    SKM_ASN1_SET_OF_i2d(ESS_CERT_ID, (st), (pp), (i2d_func), (ex_tag),  \
                        (ex_class), (is_set))
