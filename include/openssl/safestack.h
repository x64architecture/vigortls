...
#define SKM_sk_delete_ptr(type, st, ptr) \
    (type *)                             \
        sk_delete_ptr(CHECKED_STACK_OF(type, st), CHECKED_PTR_OF(type, ptr))
...
#define SKM_sk_deep_copy(type, st, copy_func, free_func)                   \
    (STACK_OF(type) *) sk_deep_copy(CHECKED_STACK_OF(type, st),            \
...
#define SKM_ASN1_seq_unpack(type, buf, len, d2i_func, free_func)  \
    (STACK_OF(type) *)                                            \
        ASN1_seq_unpack(buf, len, CHECKED_D2I_OF(type, d2i_func), \
                        CHECKED_SK_FREE_FUNC(type, free_func))
