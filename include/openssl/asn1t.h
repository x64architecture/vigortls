...
typedef ASN1_VALUE *ASN1_d2i_func(ASN1_VALUE **a, const uint8_t **in,
                                  long length);
typedef int ASN1_i2d_func(ASN1_VALUE *a, uint8_t **in);

typedef int ASN1_ex_d2i(ASN1_VALUE **pval, const uint8_t **in, long len,
                        const ASN1_ITEM *it, int tag, int aclass, char opt,
                        ASN1_TLC *ctx);

typedef int ASN1_ex_i2d(ASN1_VALUE **pval, uint8_t **out, const ASN1_ITEM *it,
                        int tag, int aclass);
...
typedef int ASN1_primitive_i2c(ASN1_VALUE **pval, uint8_t *cont, int *putype,
                               const ASN1_ITEM *it);
typedef int ASN1_primitive_c2i(ASN1_VALUE **pval, const uint8_t *cont, int len,
...
VIGORTLS_EXPORT int ASN1_item_ex_new(ASN1_VALUE **pval, const ASN1_ITEM *it);
VIGORTLS_EXPORT void ASN1_item_ex_free(ASN1_VALUE **pval, const ASN1_ITEM *it);

VIGORTLS_EXPORT int ASN1_item_ex_d2i(ASN1_VALUE **pval, const uint8_t **in, long len,
                     const ASN1_ITEM *it, int tag, int aclass, char opt,
                     ASN1_TLC *ctx);

VIGORTLS_EXPORT int ASN1_item_ex_i2d(ASN1_VALUE **pval, uint8_t **out,const ASN1_ITEM *it,
                     int tag, int aclass);
