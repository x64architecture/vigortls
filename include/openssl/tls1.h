...
VIGORTLS_EXPORT const char *SSL_get_servername(const SSL *s, const int type);
VIGORTLS_EXPORT int SSL_get_servername_type(const SSL *s);
/*
 ...
 */
VIGORTLS_EXPORT int SSL_export_keying_material(SSL *s, uint8_t *out,
                                               size_t olen, const char *label,
                                               size_t llen, const uint8_t *p,
                                               size_t plen, int use_context);

VIGORTLS_EXPORT int SSL_get_sigalgs(SSL *s, int idx, int *psign, int *phash,
                                    int *psignandhash, uint8_t *rsig,
                                    uint8_t *rhash);

VIGORTLS_EXPORT int SSL_get_shared_sigalgs(SSL *s, int idx, int *psign,
                                           int *phash, int *psignandhash,
                                           uint8_t *rsig, uint8_t *rhash);

VIGORTLS_EXPORT int SSL_check_chain(SSL *s, X509 *x, EVP_PKEY *pk,
                                    STACK_OF(X509) *chain);
...
/* ChaCha20-Poly1305 based ciphersuites from RFC7539 */
...
/* Old unstandardized ChaCha20-Poly1305 based ciphersuites */
