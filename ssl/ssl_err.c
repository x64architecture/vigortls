...
static ERR_STRING_DATA SSL_str_functs[] = {
    ...
    { ERR_FUNC(SSL_F_TLS1_CHANGE_CIPHER_STATE_AEAD),
     "TLS1_CHANGE_CIPHER_STATE_AEAD" },
    { ERR_FUNC(SSL_F_TLS1_CHANGE_CIPHER_STATE_CIPHER),
    ...
    { ERR_FUNC(SSL_F_TLS1_GET_SERVER_SUPPLEMENTAL_DATA),
     "TLS1_GET_SERVER_SUPPLEMENTAL_DATA" },
    ...
    { ERR_FUNC(SSL_F_TLS1_SEND_SERVER_SUPPLEMENTAL_DATA),
     "TLS1_SEND_SERVER_SUPPLEMENTAL_DATA" },
...
static ERR_STRING_DATA SSL_str_reasons[] = {
    ...
    { ERR_REASON(SSL_R_CIPHER_COMPRESSION_UNAVAILABLE),
     "cipher compression unavailable" },
    ...
    { ERR_REASON(SSL_R_KRB5_C_CC_PRINC), "krb5 c cc princ" },
    { ERR_REASON(SSL_R_KRB5_C_GET_CRED), "krb5 c get cred" },
    { ERR_REASON(SSL_R_KRB5_C_INIT), "krb5 c init" },
    { ERR_REASON(SSL_R_KRB5_C_MK_REQ), "krb5 c mk req" },
    { ERR_REASON(SSL_R_KRB5_S_BAD_TICKET), "krb5 s bad ticket" },
    { ERR_REASON(SSL_R_KRB5_S_INIT), "krb5 s init" },
    { ERR_REASON(SSL_R_KRB5_S_RD_REQ), "krb5 s rd req" },
    { ERR_REASON(SSL_R_KRB5_S_TKT_EXPIRED), "krb5 s tkt expired" },
    { ERR_REASON(SSL_R_KRB5_S_TKT_NYV), "krb5 s tkt nyv" },
    { ERR_REASON(SSL_R_KRB5_S_TKT_SKEW), "krb5 s tkt skew" },
    ...
    { ERR_REASON(SSL_R_MISSING_SRP_PARAM), "missing srp param" },
    ...
    { ERR_REASON(SSL_R_SRP_A_CALC), "srp a calc" },
    ...
    { ERR_REASON(SSL_R_UNKNOWN_SUPPLEMENTAL_DATA_TYPE),
     "unknown supplemental data type" },
