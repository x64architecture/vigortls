                      ...
                      X509_STORE * st, unsigned long flags)
{
    ...
    if (!(flags & OCSP_NOVERIFY)) {
        ...
        /*
         * If we trust some "other" certificates, mark them as explicitly
         * trusted (because some of them might be Intermediate CA
         * Certificates), put them in a store and attempt to build a trusted
         * chain.
         */
