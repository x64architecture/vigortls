...
{
    return (X9_62_PENTANOMIAL*)ASN1_item_new(ASN1_ITEM_rptr(X9_62_PENTANOMIAL));
}

void X9_62_PENTANOMIAL_free(X9_62_PENTANOMIAL *a)
{
    ASN1_item_free((ASN1_VALUE *)a, ASN1_ITEM_rptr(X9_62_PENTANOMIAL));
}
...
{
    return (X9_62_CHARACTERISTIC_TWO*)ASN1_item_new(ASN1_ITEM_rptr(X9_62_CHARACTERISTIC_TWO));
}

void X9_62_CHARACTERISTIC_TWO_free(X9_62_CHARACTERISTIC_TWO *a)
{
    ASN1_item_free((ASN1_VALUE *)a, ASN1_ITEM_rptr(X9_62_CHARACTERISTIC_TWO));
}
...
{
    return (ECPARAMETERS*)ASN1_item_new(ASN1_ITEM_rptr(ECPARAMETERS));
}

void ECPARAMETERS_free(ECPARAMETERS *a)
{
    ASN1_item_free((ASN1_VALUE *)a, ASN1_ITEM_rptr(ECPARAMETERS));
}
...
ECPKPARAMETERS *d2i_ECPKPARAMETERS(ECPKPARAMETERS **a, const uint8_t **in, long len)
{
    return (ECPKPARAMETERS *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, ASN1_ITEM_rptr(ECPKPARAMETERS));
}

int i2d_ECPKPARAMETERS(const ECPKPARAMETERS *a, uint8_t **out)
{
    return ASN1_item_i2d((ASN1_VALUE *)a, out, ASN1_ITEM_rptr(ECPKPARAMETERS));
}

ECPKPARAMETERS *ECPKPARAMETERS_new(void)
{
    return (ECPKPARAMETERS *)ASN1_item_new(ASN1_ITEM_rptr(ECPKPARAMETERS));
}

void ECPKPARAMETERS_free(ECPKPARAMETERS *a)
{
    ASN1_item_free((ASN1_VALUE *)a, ASN1_ITEM_rptr(ECPKPARAMETERS));
}
...
EC_PRIVATEKEY *d2i_EC_PRIVATEKEY(EC_PRIVATEKEY **a, const uint8_t **in, long len)
{
    return (EC_PRIVATEKEY *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, ASN1_ITEM_rptr(EC_PRIVATEKEY));
}

int i2d_EC_PRIVATEKEY(const EC_PRIVATEKEY *a, uint8_t **out)
{
    return ASN1_item_i2d((ASN1_VALUE *)a, out, ASN1_ITEM_rptr(EC_PRIVATEKEY));
}

EC_PRIVATEKEY *EC_PRIVATEKEY_new(void)
{
    return (EC_PRIVATEKEY *)ASN1_item_new(ASN1_ITEM_rptr(EC_PRIVATEKEY));
}

void EC_PRIVATEKEY_free(EC_PRIVATEKEY *a)
{
    ASN1_item_free((ASN1_VALUE *)a, ASN1_ITEM_rptr(EC_PRIVATEKEY));
}
...
static int ec_asn1_group2curve(const EC_GROUP *group, X9_62_CURVE *curve)
{
    ...
    uint8_t *buffer_1 = NULL, *buffer_2 = NULL,
...
EC_GROUP *ec_asn1_pkparameters2group(const ECPKPARAMETERS *params)
{
    ...
    } else if (params->type == 1) { /* the parameters are given by a ECPARAMETERS
           * structure */
...
EC_GROUP *d2i_ECPKParameters(EC_GROUP **a, const uint8_t **in, long len)
{
    EC_GROUP *group = NULL;
...
int i2d_ECPrivateKey(EC_KEY *a, uint8_t **out)
{
    ...
    if (!(a->enc_flag & EC_PKEY_NO_PUBKEY)) {
        ...
        if (tmp_len > buf_len) {
            uint8_t *tmp_buffer = realloc(buffer, tmp_len);
            if (!tmp_buffer) {
...
int i2d_ECParameters(EC_KEY *a, uint8_t **out)
{
    if (a == NULL) {
...
EC_KEY *d2i_ECParameters(EC_KEY **a, const uint8_t **in, long len)
{
    EC_KEY *ret;
...
EC_KEY *o2i_ECPublicKey(EC_KEY **a, const uint8_t **in, long len)
{
    EC_KEY *ret = NULL;
...
int i2o_ECPublicKey(EC_KEY *a, uint8_t **out)
{
    size_t buf_len = 0;
    int new_buffer = 0;
