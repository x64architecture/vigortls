...
int_dhx942_dh *d2i_int_dhx(int_dhx942_dh * *a, const uint8_t **pp, long length);
int i2d_int_dhx(const int_dhx942_dh *a, uint8_t **pp);

IMPLEMENT_ASN1_ENCODE_FUNCTIONS_const_fname(int_dhx942_dh, DHxparams, int_dhx)

/*
 * Application leve function: read X9.42 DH parameters into DH structure
 */
...
int i2d_DHxparams(const DH *dh, uint8_t **pp)
{
    int_dhx942_dh dhx;
    int_dhvparams dhv;
    ASN1_BIT_STRING bs;
