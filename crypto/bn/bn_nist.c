 ...
 */
#define bn_cp_32_naked(to, n, from, m) (((n)&1) ? (to[(n) / 2] |= ((m)&1) ? (from[(m) / 2] & BN_MASK2h) : (from[(m) / 2] << 32)) : (to[(n) / 2] = ((m)&1) ? (from[(m) / 2] >> 32) : (from[(m) / 2] & BN_MASK2l)))
                    ...
                    BN_CTX *ctx)
{
    ...
    mask &= 0 - (size_t)carry;
    res = c_d;
    res = (BN_ULONG *)(((size_t)res & ~mask) | ((size_t)r_d & mask));
...
#define nist_set_224(to, from, a1, a2, a3, a4, a5, a6, a7)                                                                                                                                                                \
    {                                                                                                                                                                                                                     \
        bn_cp_32(to, 0, from, (a7)-7) bn_cp_32(to, 1, from, (a6)-7) bn_cp_32(to, 2, from, (a5)-7) bn_cp_32(to, 3, from, (a4)-7) bn_cp_32(to, 4, from, (a3)-7) bn_cp_32(to, 5, from, (a2)-7) bn_cp_32(to, 6, from, (a1)-7) \
    }
...
#define nist_set_256(to, from, a1, a2, a3, a4, a5, a6, a7, a8)                                                                                                                                                                                          \
    {                                                                                                                                                                                                                                                   \
        bn_cp_32(to, 0, from, (a8)-8) bn_cp_32(to, 1, from, (a7)-8) bn_cp_32(to, 2, from, (a6)-8) bn_cp_32(to, 3, from, (a5)-8) bn_cp_32(to, 4, from, (a4)-8) bn_cp_32(to, 5, from, (a3)-8) bn_cp_32(to, 6, from, (a2)-8) bn_cp_32(to, 7, from, (a1)-8) \
    }
